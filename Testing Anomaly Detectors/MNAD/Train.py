...
train_folder = rf"C:\Work\2022_workstuff\Research\anomalyDetectors\MNAD\dataset\{args.dataset_type}\training\frames"
# test_folder = args.dataset_path+"\\"+args.dataset_type+"\\testing\\frames"
test_folder = rf"C:\Work\2022_workstuff\Research\anomalyDetectors\MNAD\dataset\{args.dataset_type}\testing\frames"
...
# model = torch.load(r"C:\Work\2022_workstuff\Research\anomalyDetectors\MNAD\log_dir\Avenue_prediction\model.pth")
# model.cuda()
# m_items = torch.load(r"C:\Work\2022_workstuff\Research\anomalyDetectors\MNAD\log_dir\Avenue_prediction\keys.pt")
...
torch.save(model, os.path.join(args.exp_dir, 'model.pth'))
torch.save(m_items, os.path.join(args.exp_dir, 'keys.pt'))

np.savetxt(os.path.join(args.exp_dir, 'losses.txt'),all_losses, delimiter=",")
