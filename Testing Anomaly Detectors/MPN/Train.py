...
parser.add_argument('--exp_dir', type=str, default='log_dir', help='directory of log')
...
if __name__ == "__main__":
  ...
  train_folder = rf"D:\2022_workstuff\Research\anomalyDetectors\MNAD\dataset\{args.dataset_type}\training\frames"
  ...
  log_dir = os.path.join('./log_dir', args.dataset_type, args.exp_dir)
