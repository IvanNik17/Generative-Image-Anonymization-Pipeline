...
parser.add_argument('--model_dir', type=str, default=r"C:\Work\2022_workstuff\Research\anomalyDetectors\MPN\log_dir\avenue_small_obscured\log_dir\model_59.pth",  help='directory of model')
