...
parser.add_argument('--model_dir', default=r"C:\Work\2022_workstuff\Research\anomalyDetectors\LearningNotToReconstructAnomalies\log_exp\avenue_small_obscured\log_expweight_recon\model_59.pth", type=str, help='directory of model')
