...
parser.add_argument('--num_workers', type=int, default=6, help='number of workers for the train loader')
...
parser.add_argument('--exp_dir', type=str, default='log_exp', help='basename of folder to save weights')
...
if __name__ == "__main__":
    ...
    log_dir = os.path.join('./log_dir', args.dataset_type, exp_dir)
